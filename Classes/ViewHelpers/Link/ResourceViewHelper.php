...
class Tx_Cicbase_ViewHelpers_Link_ResourceViewHelper extends Tx_Fluid_Core_ViewHelper_AbstractTagBasedViewHelper {
	...
	public function render($url) {
		...
		$this->tag->addAttribute('href', $parsed['scheme'].'://'.$parsed['host'].'/'.$url);

...
class MimeTypeUtility {
    ...
    public static function extensionToMimeType($ext) {
        return static::$mapping[$ext];
    }

    /**
     * Will provide the perceived MIME type based on the mapping in this class.
     * If no mapping found, falls back to PHP MIME detection
     *
     * @param $path
     * @return null|string
     */
    public static function mimeFromPath($path) {
        $type = null;
        if (is_file($path)) {
